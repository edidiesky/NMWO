      ...
      <div data-scroll className="min-h-[100vh] relative flex flex-col">
        ...
        <div className="w-full z-30 h-full flex-col gap-8 flex items-start ">
          ...
          <div className="w-[95%] py-12 pb-20 mx-auto max-w-custom">
            <div className="w-full flex flex-col-reverse  md:grid grid-cols-1 gap-12 md:grid-cols-custom">
              ...
              <div className="w-[90%] mx-auto h-full md:w-[300px] flex flex-col gap-16 md:gap-24">
                <div className="w-full flex flex-col gap-6 md:gap-8 text-grey  font-extrabold text-3xl md:text-4xl">
                ...
                <div className="w-full flex items-start justify-end">
                  <Link
                    ...
                    className="px-8 py-4 border-2 hover:shadow-2xl hover:opacity-[.6] cursor-pointer text-2xl md:text-3xl uppercase text-[#C6C085] border-[rgba(255,255,255,1)]"
                  >
                    CONNECT
                  </Link>
                </div>
